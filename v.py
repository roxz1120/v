...
TELEGRAM_BOT_TOKEN = '7345671533:AAGbqHl10kpSJQ6WaJcaWbjFdK9bMCzcky4'
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        ...
        return
    message = (
       "*🚀ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ıllıllı @ROXZ_GAMING DDOS server ıllıllı 🚀*\n\n"
        "*💀Use /attack <ip> <port> <duration>*\n"
        "*💀ꜱᴇʀᴠᴇʀ ꜰʀᴇᴇᴢ ᴡɪᴛʜ @@ROXZ_GAMING 🚀*" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @@ROXZ_GAMING💥*"
    ), parse_mode='Markdown')
